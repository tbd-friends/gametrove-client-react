...
/**
 * Collection statistics and summary data
 */
export interface CollectionStats {
  ...
  /** Total estimated value of collection */
  totalValue: number;
  
  /** Number of different platforms represented */
  ...
  /** Most valuable game */
  mostValuableGame?: GameCollectionSummary;
